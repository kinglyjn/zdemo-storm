...
public class RankableObjectWithFields implements Rankable, Serializable {
	 ...
	 * <p/>
	 * This method expects the object to be ranked in the first field (index 0) of
	 * the provided tuple, and the number of occurrences of the object (its count)
	 * in the second field (index 1). Any further fields in the tuple will be
	...
	/**
	 * @return an immutable list of any additional data fields of the object (may be
	 ...
	 * fields. We do guarantee, however, do return a defensive (shallow) copy of the
	 * List object that is wrapping any accompanying fields.
	 *
	 * @return
	 */
	@Override

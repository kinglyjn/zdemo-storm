...
public class Rankings implements Serializable {
	...
	/**
	 * @return the maximum possible number (size) of ranked objects this instance
	 *         can hold
	 */
	public int maxSize() {
		return maxSize;
	 ...
	 * instance, return a defensive copy of the enclosing List instance, and we do
	 * try to defensively copy any contained Rankable objects, too. However, the
	 * contract of {@link org.apache.storm.starter.tools.Rankable#copy()} does not
	 * guarantee that any Object's embedded within a Rankable will be defensively
	 * copied, too.
	 *
